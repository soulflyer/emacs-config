...
(defcustom dired-xattr-attribute-6 "#fe2e20"
  "Color to use for red label."
  :group 'dired-xattr
  :type 'color)

(defcustom dired-xattr-attribute-7 "#f97e70"
...
(defcustom dired-xattr-attribute-2 "#61db29"
...
(defcustom dired-xattr-attribute-3 "#cd63e0"
