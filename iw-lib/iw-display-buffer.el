...
(setq display-buffer-alist
      '(("*undo-tree*"     display-buffer-in-direction
        ...
        ;; ("*Org Select*"                display-buffer-same-window (inhibit-same-window . nil))
        ("Org Select"                     display-buffer-same-window (inhibit-same-window . nil))
        ;; ("Org Src"                     display-buffer-same-window (inhibit-same-window . nil))
        ;; ("Org Attach"                  display-buffer-same-window (inhibit-same-window . nil))
        ("Org Links"                      display-buffer-no-window (allow-no-window . t))
        ("CAPTURE-*"                   display-buffer-same-window (inhibit-same-window . nil))
