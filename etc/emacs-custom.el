(custom-set-variables
 ...
 '(package-selected-packages
   '(emms org-appear elpy groovy-mode flycheck-clojure inf-clojure
          align-cljlet cider clojure-mode magit minimap ob-async
          org-async with-editor user-keys company-tabnine wanderlust
          w3m mew blimp markdown-mode fzf zygospore free-keys
          font-utils xwwp projectile typescript-mode flycheck deft
          vterm ace-jump-mode abc-mode org-noter-pdftools
          ...
          org-attach-screenshot org-download gnu-apl-mode lsp-docker
          emojify emoji-cheat-sheet-plus helpful ccls eshell-vterm
          eshell-syntax-highlighting git-timemachine org-superstar
          lsp-treemacs lsp-origami lsp-ivy lsp-ui lsp-mode zetteldeft
          yaml-mode yaml xwwp-follow-link-ivy xhair xah-get-thing
          workgroups2 which-key web-mode visual-regexp
          visual-ascii-mode visible-mark verb unidecode unicode-fonts
          undo-tree underline-with-char ts-comint treemacs tide sx
